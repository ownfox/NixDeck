...
### 🕹️ Настройка EmuDeck, Decky Loader и кастомных обложек (SGDBoop)
...
3. **SGDBoop (Кастомные обложки для Steam):**
   Программа уже установлена.
   - Зайдите на сайт [SteamGridDB](https://www.steamgriddb.com) через браузер.
   - Нажмите на любую обложку и выберите кнопку с синим значком Boop.
   - Браузер спросит разрешение на открытие ссылки через SGDBoop — согласитесь, и обложка автоматически применится в вашем Steam.
